...
function initPages(entityPath, entityName, list, addEdit) {
    ...
    _editPage = "/" + _entityPath + "/Edit/";
    _createPage = "/" + _entityPath + "/Create/";
    _listPage = "/" + _entityPath + "/Index/";
    _indexPage = "/" + _entityPath + "/List/";
...
function reloadCreateWithParameters(params) {
    addLoaderInTab('tab2');
    submitUrl(_createPage, params, onReloadCreateSuccess);
}

function reloadCreate() {
    reloadCreateWithParameters('{}');
}
